...
import { Mail, User, Phone, Eye, EyeOff, ArrowLeft } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("/?message=Registration successful! Please check your email for verification.")
      } else {
      ...
      <div className="relative z-20 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">Join SkyVision Pro</h1>
            <p className="text-xl text-gray-200 font-medium">Create Your Account</p>
            <p className="text-gray-300 mt-2">Start booking professional drone services today</p>
          </div>
